...
export default function ArticleDetail() {
  ...
  return (
    <div className="relative min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 transition-colors duration-500 overflow-x-hidden font-sans selection:bg-pink-500/30">
      ...
      <header className="relative pt-32 md:pt-48 pb-12 max-w-5xl mx-auto px-6">
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-10 duration-1000">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <span className="px-4 py-1.5 rounded-full bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 text-[9px] font-black uppercase tracking-[0.2em]">
              {post.category}
            </span>
          ...
          <div className="mt-16 pt-8 border-t border-zinc-100 dark:border-zinc-900">
            ...
            <div className="flex flex-wrap gap-2">
              {post.tags.map((tag) => (
                <span 
                  key={tag} 
                  className="px-4 py-2 rounded-xl bg-zinc-50 dark:bg-zinc-900 text-[10px] font-bold uppercase tracking-widest text-zinc-600 dark:text-zinc-400 border border-zinc-100 dark:border-zinc-800 hover:border-pink-500 hover:text-pink-500 transition-all cursor-pointer active:scale-95"
                >
                  {tag}
                </span>
              ))}
      ...
      <div className="lg:hidden fixed bottom-6 left-1/2 -translate-x-1/2 w-[90%] z-[70]">
         <div className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border border-zinc-200 dark:border-zinc-800 rounded-3xl p-4 flex items-center justify-around shadow-2xl text-zinc-900 dark:text-white">
            ...
            <button className="flex flex-col items-center gap-1"><MessageCircle size={20} /><span className="text-[8px] font-black uppercase opacity-60">Chat</span></button>
            <button className="flex flex-col items-center gap-1"><Bookmark size={20} /><span className="text-[8px] font-black uppercase opacity-60">Save</span></button>
            <button className="flex flex-col items-center gap-1"><Share2 size={20} /><span className="text-[8px] font-black uppercase opacity-60">Share</span></button>
         </div>
      </div>
