...
import { Sun, Moon, Menu, X, ArrowRight, ChevronDown } from "lucide-react" // Pastikan library lucide terinstal
...
export default function Navbar() {
  ...
  // Efek scroll untuk merubah padding navbar
  useEffect(() => {
        ...
        <div className="flex justify-between items-center relative z-[110]">
          ...
          <div className="hidden md:flex items-center gap-2 p-1.5 bg-zinc-100/50 dark:bg-zinc-900/50 border border-zinc-200/50 dark:border-zinc-800/50 rounded-2xl backdrop-blur-md">
            ...
            <div className="relative group">
              ...
              {/* Dropdown Menu Wrapper (berfungsi sebagai jembatan kursor) */}
          ...
          <button 
            ...
            className="md:hidden p-3 rounded-2xl bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 shadow-lg active:scale-90 transition-transform"
          >
      ...
      <div className={`fixed inset-0 h-screen w-screen md:hidden bg-white/95 dark:bg-zinc-950/95 backdrop-blur-3xl transition-all duration-500 ease-in-out ${
        ...
        <div className="flex flex-col h-full px-8 pt-32 pb-12 overflow-y-auto">
          <div className="space-y-8">
            <Link to="/" onClick={() => setOpen(false)} className="text-4xl font-black text-zinc-900 dark:text-white">Home</Link>
            ...
            <Link to="/about" onClick={() => setOpen(false)} className="text-4xl font-black text-zinc-900 dark:text-white">About</Link>
          </div>
          
          {/* MOBILE FOOTER (Theme Toggle & Join) */}
          <div className="mt-auto space-y-6">
             ...
             <button className="w-full py-5 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 rounded-3xl font-black text-lg flex items-center justify-center gap-3 shadow-2xl shadow-pink-500/20">
